...
- 🗺️ **REST Countries API Entegrasyonu**
- 🎨 **Tailwind CSS ile Stil**
- 🛣️ **React Router ile Gezinme**
- 🏛️ **Redux Toolkit Durum Yönetimi** (pratik için)
...
- **React** ile arayüz
- **Redux Toolkit** ile durum yönetimi (öğrenme amaçlı; bu proje için local state yeterli olurdu)
- **React Router v7** ile sayfa geçişleri
- **Tailwind CSS** ile stil
- **TypeScript** ile tip güvenliği

---

## 📚 Durum Yönetimi Hakkında

> Bu projede **Redux Toolkit** pratik amaçlı kullanılmıştır.  
> Bu boyuttaki bir proje için React’ın local state’i yeterli olurdu, ancak öğrenme ve gösterim için Redux eklenmiştir.

---

## 🖼️ Ekran Görüntüleri

<img width="600" height="600" alt="Ana Sayfa" src="https://github.com/user-attachments/assets/2bc88ca7-7ffc-4e19-9b1f-f25dfc44ba8d" />
<img width="600" height="600" alt="Ülkeler Listesi" src="https://github.com/user-attachments/assets/f1489493-20aa-45be-b6dc-571fbca87c46" />
<img width="600" height="600" alt="Ülke Detayı" src="https://github.com/user-attachments/assets/d2d8e9c2-0859-47e4-bfc9-0350bf4889d0" />
